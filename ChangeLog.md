...
- \[json.hpp\] from releases doesn't work [\#2897](https://github.com/nlohmann/json/issues/2897)
...
- "Custom data source" example makes no sense [\#2423](https://github.com/nlohmann/json/issues/2423)
...
- Can't add an object in another object [\#2101](https://github.com/nlohmann/json/issues/2101)
...
- Forward header shouldn't be amalgamated [\#1700](https://github.com/nlohmann/json/issues/1700)
...
- Updating from an older version causes problems with assigning a json object to a struct [\#1630](https://github.com/nlohmann/json/issues/1630)
...
- Checking keys of two jsons against each other [\#1465](https://github.com/nlohmann/json/issues/1465)
...
- Can't compile with -C++17 and beyond compiler options [\#1362](https://github.com/nlohmann/json/issues/1362)
...
- shouldn't the cmake install target be to nlohman/json.hpp [\#668](https://github.com/nlohmann/json/issues/668)
...
- Can't modify existing numbers inside a json object [\#557](https://github.com/nlohmann/json/issues/557)
...
- UTF-8 encoding/decoding/testing [\#10](https://github.com/nlohmann/json/issues/10)
