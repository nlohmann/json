...
if(NOT DEFINED LIBCPP_VERSION_OUTPUT_CACHED)
    ...
    if(NOT LIBCPP_VERSION_OUTPUT)
        ...
        message(AUTHOR_WARNING "Failed to compile cmake/detect_libcpp_version to detect the used C++ standard library. This is does not affect the library or the test cases. Please still create an issue at https://github.com/nlohmann/json to investigate this.\n${LIBCPP_VERSION_COMPILE_OUTPUT}")
    endif()
