...
The main structure is class [nlohmann::basic_json](https://json.nlohmann.me/api/basic_json/index.md).
...
- [`ordered_json`](https://json.nlohmann.me/api/ordered_json/index.md) via [`ordered_map`](https://json.nlohmann.me/api/ordered_map/index.md)

## Value storage

Values are stored as a tagged union of [value_t](https://json.nlohmann.me/api/basic_json/value_t/index.md) and json_value.
